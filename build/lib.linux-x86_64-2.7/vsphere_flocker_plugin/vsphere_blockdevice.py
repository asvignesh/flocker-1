...
logging.basicConfig(filename='/var/log/flocker/vsphereNew.log',
                    level=logging.DEBUG,
        ...
        try:
            ...
            for device in devices:
                try:
                    ...
                    if device == "/dev/sdb":
                        output = "'6000c29d29bf0abe41e41451aa6994f7'"
                    else:
                        continue
                ...
                if serial_id_line_index < 0:
                    ...
                    continue
                serial_id = "6000c29d29bf0abe41e41451aa6994f7"
...
def main():
    vs = vsphere_from_configuration(cluster_id='1',
                                    ...
                                    ssl_cert_file='',
                                    ssl_thumbprint='')
    volume = vs.create_volume(dataset_id=uuid.uuid4(), size = 2147483648)
    vs.list_volumes()
